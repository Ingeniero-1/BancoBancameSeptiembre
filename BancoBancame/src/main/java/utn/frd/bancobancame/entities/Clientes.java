...
@NamedQueries({
    ...
    , @NamedQuery(name = "Clientes.findBySex", query = "SELECT c FROM Clientes c WHERE c.sex = :sex")})
public class Clientes implements Serializable {
    ...
    public Clientes(Integer id, String nombre, int edad, String password, int saldo, String email, String sex) {
        this.id = id;
        this.nombre = nombre;
        this.edad = edad;
